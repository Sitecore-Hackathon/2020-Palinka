namespace Hackathon.Feature.Navigation.ORM
{
    ...
    public class NavigationBaseMap : SitecoreGlassMap<INavigationBase>
    {
        ...
        public override void Configure()
        {
            Map(config =>
            {
                ...
                config.Delegate(f => f.HasUrl).GetValue(context => !string.IsNullOrEmpty(context.Item[Sitecore.FieldIDs.LayoutField]));
            });
        }
    }
}
