...
using Hackathon.Feature.Hero.Controllers;
using Hackathon.Feature.Hero.Mediators;
using Hackathon.Feature.Hero.ViewModels;
using Hackathon.Foundation.Core.Exceptions;
using Hackathon.Foundation.Core.Models;
using Microsoft.VisualStudio.TestTools.UnitTesting;
using NSubstitute;
using Ploeh.AutoFixture;
using ErrorMessages = Hackathon.Foundation.Core.Exceptions.Constants;

namespace Hackathon.Feature.Hero.Tests.Controllers
{
    [TestClass]
